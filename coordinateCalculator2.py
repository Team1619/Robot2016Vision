import math
class vertexMath:
	def __init__(self, width, height, focalLength, targetWidth=5, targetHeight=10, armLength = 34.75, armHeight = 0, armSideOffset = 6.375, cameraElevationAngle = 0.0, distToCenterOfRotation = 14.0):
	...
	def transformCoordinates(self, vertices, angle):
		...
		for i in range(0,4):
			...
			vertices2[i] = [(math.cos(vertexAngle)*vertexDistance + self.armLength), vertices[i][1] + self.armSideOffset, (math.sin(vertexAngle)*vertexDistance)]
